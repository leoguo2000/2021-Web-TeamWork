...
public class TGoodsDAO extends HibernateDaoSupport
{
	...
	public static final String GOODS_DIJIA = "goodsDijia";

	public static final String GOODS_CATELOG_ID = "goodsCatelogId";

	public static final String GOODS_USER_ID = "goodsUserId";
	...
	public List findByGoodsDijia(Object goodsDijia)
	{
		return findByProperty(GOODS_DIJIA, goodsDijia);
	}
	...
	public List findByGoodsUserId(Object goodsUserId)
	{
		return findByProperty(GOODS_USER_ID, goodsUserId);
	}
